...
**Live → https://baditaflorin.github.io/mesh-attendance-stamp/**

**Source → https://github.com/baditaflorin/mesh-attendance-stamp**
...
git clone https://github.com/baditaflorin/mesh-attendance-stamp
...
- `mesh-attendance-stamp:signalingUrl`
- `mesh-attendance-stamp:turnTokenUrl`
- `mesh-attendance-stamp:iceServers`
- `mesh-attendance-stamp:room`
